...
export const HeroSection = () => {
  ...
  return (
    ...
    >
      ...
      <div className="flex justify-center flex-col gap-5 md:basis-2/3">
        <h1 className="text-2xl md:text-3xl">HI, I&apos;M DINDA</h1>
        <h1 className="font-jura text-theme-orange text-6xl md:text-8xl font-bold">
          Web Developer
        </h1>
      </div>
